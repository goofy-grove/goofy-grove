        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text("content").not_null())
                    .col(string("author_persona_uid"))
                    .col(string("author_character_uid"))
                    .col(string("chat_uid").not_null())
                    .col(string("reply_to_message_uid"))
                    .col(boolean("is_removed").not_null().default(false))
                    .col(
